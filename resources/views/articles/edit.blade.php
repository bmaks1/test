...
@section('content')
    {{ Form::model($article, ['route' => ['articles.update', $article],'files'=>true, 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) }}
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::select('id_category',$categories , $article->id_category, ['placeholder' => 'Pick a category...']) }}
                </div>
            </div>
            <div class="form-group">
